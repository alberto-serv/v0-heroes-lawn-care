        ...
        <div className="max-w-xl mx-auto">
          <Card>
            <CardContent className="p-6 md:p-8 space-y-6">
              {/* Service Package */}
              <div>
                <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-3">Your Service</h3>
              ...
              {oneTimeServices.length > 0 && (
                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">One-Time Services</h3>
              ...
              {regularAddOns.length > 0 && (
                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Additional Services</h3>
              ...
              {perVisitServices.length > 0 && (
                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Per-Visit Services</h3>
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    A local representative will contact you to schedule your first visit and confirm final pricing on site.
                  </p>
                  <Button className="w-full bg-emerald-700 hover:bg-emerald-800 text-white mt-1" onClick={() => window.open("https://clienthub.getjobber.com", "_blank")}>
                    Go to Client Hub
                  </Button>
                </div>
              </div>
