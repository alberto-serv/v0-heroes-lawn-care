    ...
    return (
      <div className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden p-8 text-center">
        ...
        <div className="bg-muted/50 rounded-xl p-4 mb-4">
          ...
          {copied && <p className="text-xs text-green-600 mt-2">Email copied to clipboard!</p>}
        </div>

        <div className="mb-6">
          <Button variant="outline" onClick={handleCopyFormData} className="rounded-lg w-full">
            {formDataCopied ? (
              <>
    ...
    <div className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden p-8">
      <div className="text-center mb-6">
        <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-primary/10 flex items-center justify-center">
          <img src={serviceIcon} alt={serviceName} className="w-12 h-12 object-contain" />
        </div>
